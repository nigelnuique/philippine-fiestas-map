...
export const LGU_SCHEDULE_REGISTRY = [
  ...
  },
  {
    ...
    status: "complete",
    dateSource: "lgu-masantol-mpdo-scribd",
    notes: "26/26 fixed-date barangays from Municipal Planning & Development Coordinator schedule (relative rows skipped).",
  },
  {
    id: "misamis-oriental-jasaan-scribd",
    municipality: "Jasaan",
    province: "Misamis Oriental",
    format: "curated-text",
    parser: "JASAAN_FIESTA_SCHEDULE",
    status: "complete",
    dateSource: "lgu-misamis-oriental-2nd-district-scribd",
    notes: "15/15 barangays from Misamis Oriental 2nd District public schedule copy.",
  },
  {
    id: "misamis-oriental-villanueva-scribd",
    municipality: "Villanueva",
    province: "Misamis Oriental",
    format: "curated-text",
    parser: "VILLANUEVA_MISOR_FIESTA_SCHEDULE",
    status: "complete",
    dateSource: "lgu-misamis-oriental-2nd-district-scribd",
    notes: "11/11 barangays from Misamis Oriental 2nd District public schedule copy.",
  },
  {
    id: "misamis-oriental-tagoloan-scribd",
    municipality: "Tagoloan",
    province: "Misamis Oriental",
    format: "curated-text",
    parser: "TAGOLOAN_MISOR_FIESTA_SCHEDULE",
    status: "complete",
    dateSource: "lgu-misamis-oriental-2nd-district-scribd",
    notes: "10/10 fixed-date barangays from Misamis Oriental 2nd District schedule (relative rows skipped).",
  },
  {
    id: "misamis-oriental-opol-scribd",
    municipality: "Opol",
    province: "Misamis Oriental",
    format: "curated-text",
    parser: "OPOL_FIESTA_SCHEDULE",
    status: "complete",
    dateSource: "lgu-misamis-oriental-2nd-district-scribd",
    notes: "14/14 fixed-date barangays from Misamis Oriental 2nd District schedule (relative rows skipped).",
  },
  {
    id: "miagao-curated",
    municipality: "Miagao",

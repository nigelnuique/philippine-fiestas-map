...
export const LEGAL_DISCLAIMER_SECTIONS = [
  ...
  },
  {
    title: "Privacy",
    paragraphs: [
      "This is a static client-side map. It does not require sign-in, does not use analytics cookies, and does not collect personal information through the app itself.",
      "Your browser may still request fonts from Google Fonts and map tiles or data files from the hosting provider. External sites linked in the footer have their own privacy policies.",
    ],
  },
  {

...
export const LEGAL_DISCLAIMER_SECTIONS = [
  ...
  },
  {
    ...
    paragraphs: [
      "Map boundaries and place names come from philippines-json-maps, geoBoundaries, altcoder PSGC shapefiles, and psgc2 (PSA-derived, CC-BY 4.0).",
      "Named festivals are drawn from the Tourism Promotions Board (DOT/TPB) calendar, Wikipedia’s List of festivals in the Philippines (CC-BY-SA 4.0), and a project-maintained seed list. Barangay patron fiestas use the PSGC hierarchy plus imported LGU schedules (e.g. Siargao, Biliran, Dagupan, Siquijor, Magallanes), a patron-saint feast calendar, and optional Wikipedia search enrichment.",
      "See “Fiesta data references” and “Map & place data” below for links and licenses. If you redistribute derived data, you must comply with each upstream license.",
    ],
  },
  {

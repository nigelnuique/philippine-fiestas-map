...
export const LGU_SCHEDULE_REGISTRY = [
  ...
  },
  {
    ...
    notes: "38/38 barangays from DAHOM Lagonoy barangay festivities list.",
  },
  {
    ...
    notes: "24/24 fixed-date barangays from Santa Maria CLUP 2006-2015 Table LU-24 (relative rows skipped).",
  },
  {
  ...
  },
  {
    ...
    municipality: "Ubay",
    province: "Bohol",
    url: "https://en.wikipedia.org/wiki/Ubay,_Bohol",
    format: "curated-text",
    parser: "UBAY_WIKIPEDIA_FIESTA_SCHEDULE",
    status: "complete",
    dateSource: "wikipedia-ubay-bohol-barangay-table",
    notes: "44/44 fixed-date barangays from Wikipedia Ubay barangay table (relative rows skipped).",
  },
  {
    id: "miagao-curated",
    municipality: "Miagao",

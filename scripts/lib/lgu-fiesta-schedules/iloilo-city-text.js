...
export const ILOILO_CITY_FIESTA_ENTRIES = [
  ...
  },
  {
    ...
    dateSource: "theoldchurches-immaculate-conception-church-tanza",
    note: "TheOldChurches Immaculate Conception (Tanza) Church, Ledesma Street — feast December 8; 1:1 Ledesma Street ↔ Simon Ledesma barangay",
  },
  {
    barangay: "San Isidro (Jaro)",
    municipality: "City Of Iloilo (Capital)",
    province: "Iloilo",
    month: 5,
    dayStart: 1,

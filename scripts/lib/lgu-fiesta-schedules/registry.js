...
export const LGU_SCHEDULE_REGISTRY = [
  ...
  {
    id: "bulacan-pdpfp-marilao",
    municipality: "Marilao",
    province: "Bulacan",
    url: "https://bulacan.gov.ph/wp-content/uploads/2025/04/BulacanPDPFP_2024-2036.pdf",
    format: "curated-text",
    parser: "MARILAO_PDPFP_FIESTA_SCHEDULE",
    status: "complete",
    dateSource: "lgu-bulacan-pdpfp-2024",
    notes: "16/16 barangays from PDPFP Table 3.4.42.",
  },
  {
    id: "bulacan-pdpfp-meycauayan",
    municipality: "City Of Meycauayan",
    province: "Bulacan",
    url: "https://bulacan.gov.ph/wp-content/uploads/2025/04/BulacanPDPFP_2024-2036.pdf",
    format: "curated-text",
    parser: "MEYCAUAYAN_PDPFP_FIESTA_SCHEDULE",
    status: "partial",
    dateSource: "lgu-bulacan-pdpfp-2024",
    notes: "21 barangay barrio-fiesta rows from PDPFP Table 3.4.42; Easter-only and month-only rows skipped.",
  },
  {
    id: "bulacan-pdpfp-pandi",
    municipality: "Pandi",
    province: "Bulacan",
    url: "https://bulacan.gov.ph/wp-content/uploads/2025/04/BulacanPDPFP_2024-2036.pdf",
    format: "curated-text",
    parser: "PANDI_PDPFP_FIESTA_SCHEDULE",
    status: "partial",
    dateSource: "lgu-bulacan-pdpfp-2024",
    notes: "13 barangay feast rows from PDPFP Table 3.4.42; undated/month-only rows skipped.",
  },
  {
    id: "bulacan-pdpfp-paombong",
    municipality: "Paombong",
    province: "Bulacan",
    url: "https://bulacan.gov.ph/wp-content/uploads/2025/04/BulacanPDPFP_2024-2036.pdf",
    format: "curated-text",
    parser: "PAOMBONG_PDPFP_FIESTA_SCHEDULE",
    status: "partial",
    dateSource: "lgu-bulacan-pdpfp-2024",
    notes: "12 barangay feast rows from PDPFP Table 3.4.42; dual/usually-held rows skipped.",
  },
  {
    id: "bulacan-pdpfp-san-ildefonso",
    municipality: "San Ildefonso",
    province: "Bulacan",
    url: "https://bulacan.gov.ph/wp-content/uploads/2025/04/BulacanPDPFP_2024-2036.pdf",
    format: "curated-text",
    parser: "SAN_ILDEFONSO_BULACAN_PDPFP_FIESTA_SCHEDULE",
    status: "partial",
    dateSource: "lgu-bulacan-pdpfp-2024",
    notes: "11 barangay feast rows from PDPFP Table 3.4.42.",
  },
  {
    id: "bulacan-pdpfp-angat",
    municipality: "Angat",
    province: "Bulacan",
    url: "https://bulacan.gov.ph/wp-content/uploads/2025/04/BulacanPDPFP_2024-2036.pdf",
    format: "curated-text",
    parser: "ANGAT_PDPFP_FIESTA_SCHEDULE",
    status: "partial",
    dateSource: "lgu-bulacan-pdpfp-2024",
    notes: "15 barangay feast rows from PDPFP Table 3.4.42; duplicate Santa Cruz rows skipped.",
  },
  {
    id: "bulacan-pdpfp-bulacan",
    municipality: "Bulacan",
    province: "Bulacan",
    url: "https://bulacan.gov.ph/wp-content/uploads/2025/04/BulacanPDPFP_2024-2036.pdf",
    format: "curated-text",
    parser: "BULACAN_TOWN_PDPFP_FIESTA_SCHEDULE",
    status: "complete",
    dateSource: "lgu-bulacan-pdpfp-2024",
    notes: "14/14 barangays from PDPFP Table 3.4.42.",
  },
  {
    id: "bulacan-pdpfp-guiguinto",
    municipality: "Guiguinto",
    province: "Bulacan",
    url: "https://bulacan.gov.ph/wp-content/uploads/2025/04/BulacanPDPFP_2024-2036.pdf",
    format: "curated-text",
    parser: "GUIGUINTO_PDPFP_FIESTA_SCHEDULE",
    status: "complete",
    dateSource: "lgu-bulacan-pdpfp-2024",
    notes: "14/14 barangays from PDPFP Table 3.4.42.",
  },
  {
    id: "bulacan-pdpfp-hagonoy",
    municipality: "Hagonoy",
    province: "Bulacan",
    url: "https://bulacan.gov.ph/wp-content/uploads/2025/04/BulacanPDPFP_2024-2036.pdf",
    format: "curated-text",
    parser: "HAGONOY_PDPFP_FIESTA_SCHEDULE",
    status: "complete",
    dateSource: "lgu-bulacan-pdpfp-2024",
    notes: "26/26 barangays from PDPFP Table 3.4.42.",
  },
  {
    id: "bulacan-pdpfp-san-rafael",
    municipality: "San Rafael",
    province: "Bulacan",
    url: "https://bulacan.gov.ph/wp-content/uploads/2025/04/BulacanPDPFP_2024-2036.pdf",
    format: "curated-text",
    parser: "SAN_RAFAEL_PDPFP_FIESTA_SCHEDULE",
    status: "partial",
    dateSource: "lgu-bulacan-pdpfp-2024",
    notes: "33/34 barangay feast rows from PDPFP Table 3.4.42; Easter Sunday and duplicate-patron rows skipped.",
  },
  {
    id: "bulacan-pdpfp-bustos",
    municipality: "Bustos",
    province: "Bulacan",
    url: "https://bulacan.gov.ph/wp-content/uploads/2025/04/BulacanPDPFP_2024-2036.pdf",
    format: "curated-text",
    parser: "BUSTOS_PDPFP_FIESTA_SCHEDULE",
    status: "partial",
    dateSource: "lgu-bulacan-pdpfp-2024",
    notes: "2 barangay feast rows from PDPFP Table 3.4.42; month-only civic festivals skipped.",
  },
  {
    id: "bulacan-pdpfp-pulilan",
    municipality: "Pulilan",
    province: "Bulacan",
    url: "https://bulacan.gov.ph/wp-content/uploads/2025/04/BulacanPDPFP_2024-2036.pdf",
    format: "curated-text",
    parser: "PULILAN_PDPFP_FIESTA_SCHEDULE",
    status: "partial",
    dateSource: "lgu-bulacan-pdpfp-2024",
    notes: "Poblacion Carabao Festival May 14-15 from PDPFP Table 3.4.42.",
  },
  {
    id: "bulacan-pdpfp-calumpit",
    municipality: "Calumpit",
    province: "Bulacan",
    url: "https://bulacan.gov.ph/wp-content/uploads/2025/04/BulacanPDPFP_2024-2036.pdf",
    format: "curated-text",
    parser: "CALUMPIT_PDPFP_FIESTA_SCHEDULE",
    status: "partial",
    dateSource: "lgu-bulacan-pdpfp-2024",
    notes: "Poblacion Libad fluvial festival June 23 from PDPFP Table 3.4.42.",
  },
  {
    id: "bulacan-pdpfp-obando",
    municipality: "Obando",
    province: "Bulacan",
    url: "https://bulacan.gov.ph/wp-content/uploads/2025/04/BulacanPDPFP_2024-2036.pdf",
    format: "curated-text",
    parser: "OBANDO_PDPFP_FIESTA_SCHEDULE",
    status: "partial",
    dateSource: "lgu-bulacan-pdpfp-2024",
    notes: "Pag-asa Obando Fertility Festival May 17-19 from PDPFP Table 3.4.42.",
  },
  {
    id: "bulacan-pdpfp-balagtas",
    municipality: "Balagtas (Bigaa)",
    province: "Bulacan",
    url: "https://bulacan.gov.ph/wp-content/uploads/2025/04/BulacanPDPFP_2024-2036.pdf",
    format: "curated-text",
    parser: "BALAGTAS_PDPFP_FIESTA_SCHEDULE",
    status: "partial",
    dateSource: "lgu-bulacan-pdpfp-2024",
  ...
  {
    id: "misamis-oriental-2nd-district-lugait",
    municipality: "Lugait",
    province: "Misamis Oriental",
    url: "https://www.scribd.com/doc/270867869/Municipalities-Feast-Date-2nd-District",
    format: "curated-text",
    parser: "LUGAIT_FIESTA_SCHEDULE",
    status: "complete",
    dateSource: "lgu-misamis-oriental-2nd-district-scribd",
    notes: "8/8 barangays from Misamis Oriental 2nd District feast-date table.",
  },
  {
    id: "misamis-oriental-2nd-district-el-salvador",
  ...
  {
    id: "misamis-oriental-2nd-district-initao",
    municipality: "Initao",
    province: "Misamis Oriental",
    url: "https://www.scribd.com/doc/270867869/Municipalities-Feast-Date-2nd-District",
    format: "curated-text",
    parser: "INITAO_MISOR_FIESTA_SCHEDULE",
    status: "complete",
    dateSource: "lgu-misamis-oriental-2nd-district-scribd",
    notes: "16/16 Initao barangays from Misamis Oriental 2nd District feast-date table.",
  },
  {
    id: "misamis-oriental-2nd-district-naawan",
    municipality: "Naawan",
    province: "Misamis Oriental",
    url: "https://www.scribd.com/doc/270867869/Municipalities-Feast-Date-2nd-District",
    format: "curated-text",
    parser: "NAAWAN_MISOR_FIESTA_SCHEDULE",
    status: "partial",
    dateSource: "lgu-misamis-oriental-2nd-district-scribd",
    notes: "9/10 Naawan barangays; Lubilan has no feast date in the LGU table.",
  },
  {
    id: "misamis-oriental-2nd-district-gitagum",
    municipality: "Gitagum",
    province: "Misamis Oriental",
    url: "https://www.scribd.com/doc/270867869/Municipalities-Feast-Date-2nd-District",
    format: "curated-text",
    parser: "GITAGUM_MISOR_FIESTA_SCHEDULE",
    status: "complete",
    dateSource: "lgu-misamis-oriental-2nd-district-scribd",
    notes: "11/11 Gitagum barangays from Misamis Oriental 2nd District feast-date table.",
  },
  {
    id: "misamis-oriental-2nd-district-laguindingan",
    municipality: "Laguindingan",
    province: "Misamis Oriental",
    url: "https://www.scribd.com/doc/270867869/Municipalities-Feast-Date-2nd-District",
    format: "curated-text",
    parser: "LAGUINDINGAN_MISOR_FIESTA_SCHEDULE",
    status: "complete",
    dateSource: "lgu-misamis-oriental-2nd-district-scribd",
    notes: "11/11 Laguindingan barangays from Misamis Oriental 2nd District feast-date table.",
  },
  {
    id: "misamis-oriental-2nd-district-manticao",
    municipality: "Manticao",
    province: "Misamis Oriental",
    url: "https://www.scribd.com/doc/270867869/Municipalities-Feast-Date-2nd-District",
    format: "curated-text",
    parser: "MANTICAO_MISOR_FIESTA_SCHEDULE",
    status: "complete",
    dateSource: "lgu-misamis-oriental-2nd-district-scribd",
    notes: "13/13 Manticao barangays from Misamis Oriental 2nd District feast-date table.",
  },
  {
    id: "misamis-oriental-2nd-district-claveria",
    municipality: "Claveria",
    province: "Misamis Oriental",
    url: "https://www.scribd.com/doc/270867869/Municipalities-Feast-Date-2nd-District",
    format: "curated-text",
    parser: "CLAVERIA_MISOR_FIESTA_SCHEDULE",
    status: "partial",
    dateSource: "lgu-misamis-oriental-2nd-district-scribd",
    notes: "22/24 Claveria barangays; Kalawitan absent from the LGU table.",
  },
  {
    id: "misamis-oriental-2nd-district-alubijid",
    municipality: "Alubijid",
    province: "Misamis Oriental",
    url: "https://www.scribd.com/doc/270867869/Municipalities-Feast-Date-2nd-District",
    format: "curated-text",
    parser: "ALUBIJID_MISOR_FIESTA_SCHEDULE",
    status: "complete",
    dateSource: "lgu-misamis-oriental-2nd-district-scribd",
    notes: "16/16 Alubijid barangays from Misamis Oriental 2nd District feast-date table.",
  },
  {
    id: "misamis-oriental-2nd-district-libertad",
    municipality: "Libertad",
    province: "Misamis Oriental",
    url: "https://www.scribd.com/doc/270867869/Municipalities-Feast-Date-2nd-District",
    format: "curated-text",
    parser: "LIBERTAD_MISOR_FIESTA_SCHEDULE",
    status: "complete",
    dateSource: "lgu-misamis-oriental-2nd-district-scribd",
    notes: "9/9 Libertad barangays from Misamis Oriental 2nd District feast-date table.",
  },
  {
  ...
  {
    id: "misamis-oriental-1st-district-gingoog-outlying",
    municipality: "City Of Gingoog",
    province: "Misamis Oriental",
    url: "https://www.scribd.com/doc/270868638/Municipalities-Feast-Date-1st-District",
    format: "curated-text",
    parser: "GINGOOG_OUTLYING_FIESTA_SCHEDULE",
    status: "complete",
    dateSource: "lgu-misamis-oriental-1st-district-scribd",
    notes: "50 outlying barangays from the Gingoog feast-date table in the Misamis Oriental 1st District schedule.",
  },
  {
    id: "misamis-oriental-1st-district-gingoog-poblacion",
    municipality: "City Of Gingoog",
    province: "Misamis Oriental",
    url: "https://www.scribd.com/doc/270868638/Municipalities-Feast-Date-1st-District",
    format: "curated-text",
    parser: "GINGOOG_POBLACION_FIESTA_SCHEDULE",
    status: "complete",
    dateSource: "lgu-misamis-oriental-1st-district-scribd",
    notes: "29 Poblacion barangays from the Misamis Oriental 1st District feast-date table.",
  },
  {
    id: "misamis-oriental-1st-district-balingasag",
    municipality: "Balingasag",
    province: "Misamis Oriental",
    url: "https://www.scribd.com/doc/270868638/Municipalities-Feast-Date-1st-District",
    format: "curated-text",
    parser: "BALINGASAG_FIESTA_SCHEDULE",
    status: "complete",
    dateSource: "lgu-misamis-oriental-1st-district-scribd",
    notes: "30/30 barangays from Misamis Oriental 1st District feast-date table.",
  },
  {
  ...
  },
  {
    ...
    status: "partial",
    dateSource: "lgu-misamis-oriental-1st-district-scribd",
    notes: "9/10 barangays; Kaulayanan has no feast date in the LGU schedule.",
  },
  {
    id: "binuangan-parish",
    municipality: "Binuangan",
    province: "Misamis Oriental",
    url: "https://binuanganparish.wordpress.com/",
    format: "curated-text",
    parser: "BINUANGAN_FIESTA_SCHEDULE",
    status: "complete",
    dateSource: "parish-binuangan-our-lady-of-lourdes",
    notes: "8/8 barangays from Our Lady of Lourdes Parish chapel feast-day pages, with Poblacion cross-checked against the parish/town fiesta date.",
  },
  {
    id: "misamis-oriental-1st-district-salay",
    municipality: "Salay",
    province: "Misamis Oriental",
    url: "https://www.scribd.com/doc/270868638/Municipalities-Feast-Date-1st-District",
    format: "curated-text",
    parser: "SALAY_FIESTA_SCHEDULE",
    status: "complete",
    dateSource: "lgu-misamis-oriental-1st-district-scribd",
    notes: "18/18 barangays from the Salay feast-date table in the Misamis Oriental 1st District schedule.",
  },
  {
    id: "misamis-oriental-1st-district-lagonglong",
    municipality: "Lagonglong",
    province: "Misamis Oriental",
    url: "https://www.scribd.com/doc/270868638/Municipalities-Feast-Date-1st-District",
    format: "curated-text",
    parser: "LAGONGLONG_MISOR_FIESTA_SCHEDULE",
    status: "complete",
    dateSource: "lgu-misamis-oriental-1st-district-scribd",
    notes: "10/10 barangays from the Lagonglong feast-date table in the Misamis Oriental 1st District schedule.",
  },
  {
  ...
  },
  {
    ...
    status: "complete",
    dateSource: "lgu-misamis-oriental-1st-district-scribd",
    notes: "19/19 barangays from the clearer translated copy of the Misamis Oriental 1st District feast-date table.",
  },
  {
    id: "miagao-curated",
    municipality: "Miagao",
  ...
  },
  {
    ...
    notes: "TheOldChurches 1:1 matches: Baybay (3), Bato, Matalom, Hilongos, Palo, Inopacan, Abuyog (2), Ormoc Libertad, Carigara, Alangalang, Tolosa, Tacloban New Kawayan, Calubian, Tanauan, Albuera, Mahaplag, Merida, Tabango, Hindang Poblacion 1, Julita, Mayorga, Tabontabon, Burauen, Barugo, Capoocan, Jaro District I (Pob.)",
  },
  {
  ...
  },
  {
    ...
    notes: "TheOldChurches barangay parish pages with address-level 1:1 PSGC matches; town-parish District I (Pob.): Gainza",
  },
  {
